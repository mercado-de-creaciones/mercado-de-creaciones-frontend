...
export const CarouselCard = () => {
  return (
    <div>
      <Card
        className="-z-20 bg-home-75 aspect-[7/12] sm:max-w-5 md:max-w-full p-0 border-0 m-0 relative md:min-w-32"
        style={{
      ...
      >
        ...
        <CardContent className="absolute bottom-0">
          <TypographyP className="leading-tight font-semibold">
            Estilos para tu compañero de pelo corto
          </TypographyP>
          <TypographyP className="leading-tight">
            Descubre la moda canina para pelajes cortos y haz que tu compañero
            sobresalga.
          </TypographyP>
        </CardContent>
      </Card>
